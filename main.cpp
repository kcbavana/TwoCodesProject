/* -----------------------------------------------------------
   Program 4: Two Codes
   Pair Program
   Class: CS 141, Spring 202.  Tues 4pm lab
   System: CLion
   Author: Krish Bavana
   Patner: Madhava Sai Yamike
    -----------------------------------------------------------
 */
...
const char fileName[] = "D:\\College\\ConstitutionAndBillOfRights.txt"; //setting up the file name, so I don't need to call everywhere

//---------------------------------------------------------------------------
//to convert the string into lower cases because it is eaiser to compare words
string toLowerWord(string word){
    for(char & i : word){ //loop to convert all the letters of the word into lower case
        i = tolower(i); //using tolower()
    }
